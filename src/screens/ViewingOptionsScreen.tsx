...
interface ViewingOptionsScreenProps {
  onNext: () => void;
}

export const ViewingOptionsScreen: React.FC<ViewingOptionsScreenProps> = ({ onNext }) => {
  ...
  return (
    ...
    >
      ...
      <View style={styles.headerContainer}>
        <Text style={styles.titleText}>VIEWING OPTIONS</Text>
      </View>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.optionsContainer}>
          {viewingOptions.map((option, index) => {
            ...
            const isSelectable = option.isEnabled;
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  { 
                    ...
                    borderColor: isSelected ? '#E74C3C' : (isSelectable ? '#E0E0E0' : '#CCCCCC'),
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity 
          ...
          onPress={selectedOption ? onNext : undefined}
...
export default ViewingOptionsScreen;